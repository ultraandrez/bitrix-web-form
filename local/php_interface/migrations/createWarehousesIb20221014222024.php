...
class createWarehousesIb20221014222024 extends Version
{
	protected $description = "Создание ИБ со складами поставки";
	...
	public function up()
	{
		...
		$iblockId = $helper->Iblock()->saveIblock(array(
			...
			'CODE' => 'supplywarehouses',
			'API_CODE' => 'supplywarehouses',
			'REST_ON' => 'N',
	...
	{
		$helper = $this->getHelperManager();
		$helper->Iblock()->deleteIblockIfExists('supplywarehouses');
	}
}
