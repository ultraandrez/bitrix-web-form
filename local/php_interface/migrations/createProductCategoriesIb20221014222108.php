...
class createProductCategoriesIb20221014222108 extends Version
{
	protected $description = "Создание ИБ с категориями продуктов";
	...
	{
		$helper = $this->getHelperManager();
		$helper->Iblock()->deleteIblockIfExists('productcategories');
	}
}
